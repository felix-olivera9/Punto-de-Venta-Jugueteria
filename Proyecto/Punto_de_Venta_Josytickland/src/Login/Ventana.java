...
public class Ventana extends javax.swing.JFrame {
    ...
    TablaDatos.setFont(new Font("Comic Sans MS", Font.PLAIN, 13));
...
private void personalizarBoton(JButton boton) {
    ...
    // Crear un nuevo Border para el botón
    ...
    // Sobrescribir paintComponent para el fondo redondeado
    ...
    boton.setUI(new BasicButtonUI() {
        ...
        public void paint(Graphics g, JComponent c) {
            ...
            if (model.isPressed()) {
                g2.setColor(new Color(82, 184, 235));
            } else if (model.isRollover()) {
                g2.setColor(new Color(122, 224, 255));
            } else {
                g2.setColor(new Color(102, 204, 255));
            }
    ...
    lblBuscar.setFont(new Font("Comic Sans MS", Font.PLAIN, 14));
    lblBuscar.setForeground(new Color(70, 70, 70));
    
    txtBusc.setFont(new Font("Comic Sans MS", Font.PLAIN, 13));
    
    // Borde redondeado alternativo (sin necesidad de clase RoundBorder)
    txtBusc.setBorder(BorderFactory.createCompoundBorder(
        BorderFactory.createLineBorder(new Color(102, 204, 255), 2),
    ...
    Font menuFont = new Font("Comic Sans MS", Font.BOLD, 14);
...
private void personalizarMenuItem(JMenuItem menuItem, Color colorFondo) {
    // Fuente
    menuItem.setFont(new Font("Comic Sans MS", Font.PLAIN, 13));
   ...
   public String getContraseñaSeleccionada() {
    ...
    private void initComponents() {
        ...
        getContentPane().add(scrTabla, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 95, 870, 233));
        getContentPane().add(txtBusc, new org.netbeans.lib.awtextra.AbsoluteConstraints(116, 32, 232, -1));

        lblBuscar.setText("Buscador:");
        getContentPane().add(lblBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 37, 80, -1));
        ...
        getContentPane().add(botonAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 360, -1, -1));
        ...
        getContentPane().add(Elimnr, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 400, -1, -1));
        ...
        getContentPane().add(Agrnue, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 390, -1, -1));
        ...
        getContentPane().add(Agrexist, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 402, -1, -1));
        ...
        getContentPane().add(botonEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 360, -1, -1));
        ...
        getContentPane().add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(889, 95, -1, -1));
        ...
        getContentPane().add(btnAgregarus, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 360, -1, -1));
        ...
        getContentPane().add(btnEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 360, -1, -1));
